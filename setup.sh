...
# Remote: curl https://raw.githubusercontent.com/3xploiter/z2h-k3s-guide/main/setup.sh | CMD=install bash
###
...
CONTEXT_NAME="${CONTEXT_NAME:-z2h-DEVX}"
K3S_CHANNEL="${K3S_CHANNEL:-stable}"
REPO_RAW_URL="${REPO_RAW_URL:-https://raw.githubusercontent.com/3xploiter/z2h-k3s-guide/main}"
